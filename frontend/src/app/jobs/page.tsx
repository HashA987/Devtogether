...
import { Briefcase, Divide, Filter, MapPin, Search, X } from "lucide-react";
        ...
        <div className="mb-8 ">
          <div className="flex items-center justify-between flex-wrap gap-4 mb-4">
            ...
            <Button className="gap-2 h-11" onClick={clickEvent}>
              ...
              {hasActiveFilters && (
                <span
                  className="ml-1 px-2 py-0.5 rounded-full bg-red-500
              text-white text-xs"
                ></span>
              )}
            </Button>
          ...
          {hasActiveFilters && (
            <div className="flex items-center gap-2 flex-wrap">
              ...
              bg-blue-100 dark:bg-blue-900/30 text-blue-600 text-sm"
                >
                  <Search size={14} />
                  {title}
                  <button
            ...
            <div className="space-y-5 py-4">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  bg-transparent focus:outline-none focus:ring2"
                >
                  {locations.map((e) => (
