  ...
  return (
    <div className="min-h-screen bg-secondary/30">
                    ...
                    <div className="flex-1 ">
                      <div className="flex items-center gap-3 mb-3">
                        <span
                         ...
                         ${job.is_active ? "bg-green-100 dark:bg-green-900/30 text-green-600" : "bg-red-100 dark:bg-red-900/30 text-red-600"}`}
                        >
                      ...
                      <div className="flex items-center gap-2 text-base  mb-2 text-white">
                        <Building2 size={20} />
                    ...
                    {user && user.role === "jobseeker" && (
                      ...
                      >
                        {applied ? (
                          <>
                            <div
                              className="flex items-center gap-2 px-6 py-3 rounded-lg bg-green-100
                            dark:bg-gray-900/30 text-green-600 font-medium"
                            >
      ...
      {user && job && user.user_id === job.posted_by_recruiter_id && (
        ...
        container mx-auto mt-8 mb-8"
        >
          <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
            <h2 className="text-2xl font-bold">All Application</h2>
              ...
              <div className="space-y-4">
                {filteredApplications.map((e) => (
                  ...
                  >
                    ...
                    <div className="flex gap-2 ot-3 border-t">
                      <select
                        value={value}
